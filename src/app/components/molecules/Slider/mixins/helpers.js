...
const helpers = {
    ...
    initialize: function (props) {
        ...
        this.setState({ slideCount, slideWidth, listWidth, trackWidth, currentSlide, slideHeight, listHeight }, function () {
    ...
    update: function (props) {
        ...
        this.setState({ slideCount, slideWidth, listWidth, trackWidth, slideHeight, listHeight }, function () {
    ...
    // console.log('slideHandler', index);
        ...
        if (this.props.fade) {
            ...
            if (this.props.lazyLoad && this.state.lazyLoadedList.indexOf(targetSlide) < 0) {
                this.setState({ lazyLoadedList: this.state.lazyLoadedList.concat(targetSlide) });
            }
    ...
    autoPlay: function () {
        ...
        if (this.props.autoplay) {
            this.setState({ autoPlayTimer: setTimeout(this.play, this.props.autoplaySpeed) });
        }
    },

...
import { THING_CHILDREN_DATA_TABLE } from 'app/config/dataTableIds';
...
import { loadChildren } from 'store/actions/entities/thingsActions';
 ...
 */
class ThingChildrenGrid extends Component<Object, Object> {
    static propTypes = {
    ...
    constructor(props) {
        super((props: Object));
        (this: Object).loadChildren = this.loadChildren.bind(this);
    }
        ...
        return [
            {
                ...
                field: 'name',
                sortable: false,
                bodyComponent: ThingLink,
                bodyComponentDataMap: { id: 'id', children: 'name' },
            },
            {
                header: 'Thing ID',
                field: 'id',
                ...
                sortable: false,
                bodyComponent: ThingLink,
                bodyComponentDataMap: { id: 'id', children: 'id' },
                style: { width: '120px' },
            },
            {
                header: 'Icon',
                field: 'iconName',
                bodyComponent: ({ value, data }) => <StyledIcon name={ value || '' } color={ data && data.iconColor } />,
                bodyComponentDataMap: { title: 'iconName', name: 'iconName', color: 'iconColor' },
                filter: false,
                sortable: false,
    ...
    render(): Object {
        ...
        return (
            <TreeDataTable
                dataTableId={THING_CHILDREN_DATA_TABLE}
...
export default connect(
    ...
    { loadChildren, loadClassificationsDropDownForGrid },
)(ThingChildrenGrid);
